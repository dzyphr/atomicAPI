...
def connect():
    ...
    if usingMnemonicPass == True:
        ...
        senderAddress = helper_functions.get_wallet_address(ergo=ergo, amount=10, wallet_mnemonic=wallet_mnemonic, mnemonic_password=mnemonic_password)
    else:
        #WITHOUT MNEMONIC PASSWORD
        senderAddress = helper_functions.get_wallet_address(ergo=ergo, amount=10, wallet_mnemonic=wallet_mnemonic)
